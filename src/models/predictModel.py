...
# ----------------- Read dataset -----------------
df = pd.read_pickle("../../data/interim/dataFeatures.pkl")
...
score_df.sort_values(by="accuracy", ascending=True)
...
accuracy_score = sm.accuracy_score(y_test, class_test_y)

classes = class_test_prob_y.columns

cm = sm.confusion_matrix(y_test, class_test_y, labels=classes)
